...
def main():
    print("=" * 60)
    print("🔧 Book Research MCP - Setup Wizard")
    print("=" * 60)
    print()
    ...
    print("  • macOS:   ~/Zotero")
    print("  • Linux:   ~/Zotero")
    print("  • Windows: C:\\Users\\<username>\\Zotero")
    print()
    ...
    if not os.path.exists(zotero_path):
        print(f"❌ Path not found: {zotero_path}")
    ...
    if not os.path.exists(zotero_db):
        print(f"❌ zotero.sqlite not found in {zotero_path}")
    ...
    # Get Scrivener path
    print("📝 SCRIVENER CONFIGURATION")
    print("-" * 60)
    print("Find your Scrivener project (.scriv bundle):")
    print("  • macOS:   ~/Documents or ~/Dropbox/Apps/Scrivener")
    print("  • Windows: C:\\Users\\<username>\\Documents")
    print()
    ...
    if not os.path.exists(scrivener_path):
        print(f"❌ Path not found: {scrivener_path}")
        print("   Please check the path and try again.")
        return
...
"""
    ...
    if create_local != 'n':
        ...
        print()
        print("🔍 Scanning Zotero collections...")
        ...
        try:
            ...
            print(f"   ⚠️  Couldn't scan collections: {e}")
            collections = []
